...
//!     let mut client = WorldClient::<HelloService>::new(WorldChannel::spawn(client::Config::default(), client_transport));
//!
...
/// Implemented by the request types generated by lrcall::service.
