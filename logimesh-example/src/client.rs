...
async fn main() -> anyhow::Result<()> {
    ...
    let mut transport = logimesh::serde_transport::tcp::connect(flags.server_addr, Json::default);
    transport.config_mut().max_frame_length(usize::MAX);

    // WorldClient is generated by the component attribute. It has a constructor `new` that takes a
